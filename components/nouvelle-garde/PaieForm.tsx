  ...
  const detailData = useMemo(() => {
    ...
    const buildFam = (indemRatio: number, apercu: typeof apercuA, rac: number, isA: boolean): FamCalcData => {
      ...
      return {
        ...
        brut: apercu.brut,
        cotisationsSalariales: apercu.cotisations.totalSalarie,
        cotisationsPatronales: apercu.cotisations.totalEmployeur,
    ...
    const nounou: NounouCalcData = {
      ...
      cotisationsSalariales: Math.round((famAData.cotisationsSalariales + famBData.cotisationsSalariales) * 100) / 100,
      cotisationsPatronales: Math.round((famAData.cotisationsPatronales + famBData.cotisationsPatronales) * 100) / 100,
